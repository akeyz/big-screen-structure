...
function initPieChart() {
    ...
    const color = ['#73DDFF', '#73ACFF', '#FDD56A', '#FDB36A', '#FD866A', '#9E87FF', '#58D5FF'];
    let option = {
        color: color,
        title: {
            show: false
...
function initCircleChart() {
    let chart = echarts.init(document.getElementById("circle-chart"));

    const data = [{ name: 'AA', value: 200 }, { name: 'BB', value: 300 }, { name: 'CC', value: 500 }]
    const color = ['#73DDFF', '#73ACFF', '#FDD56A', '#FDB36A', '#FD866A', '#9E87FF', '#58D5FF'];
    let option = {
...
function initTreeChart() {
    let chart = echarts.init(document.getElementById("tree-chart"));
    let nodes = [{
        x: 500,
        y: 1000,
        nodeName: '应用',
    ...
    for (let j = 0; j < nodes.length; j++) {
        ...
        let node = {
            nodeName,
            value: [x, y],
            symbolSize: symbolSize || [40, 20],
            symbol: 'rect', //'path://' + svgPath,
            itemStyle: {
                color: 'red',
            }
        }
...
function computeVal(data, index) {
    let val = 0;
